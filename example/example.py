...
#to sign a request, you need to provide a dict which contain 'varb', 'uri', 'headers'
if __name__ == '__main__':
    ...
    signer = aws_sign.Signer(access_key, secret_key)
    signer.add_auth(request, presign=True)
    print request['uri']
    print request['headers']
    ...
    signer = aws_sign.Signer(access_key, secret_key)
    signer.add_auth(request, presign=True, expires=60*60*24)
    print request['uri']
    print request['headers']
    ...
    signer = aws_sign.Signer(access_key, secret_key)
    signer.add_auth(request, headers_not_to_sign=['will-not-be-signed-h1', 'will-not-be-signed-h2'])
    print request['uri']
    print request['headers']
    # > /aaa/bbb
